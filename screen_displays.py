...
class Hud:
    def __init__(self):
        self.score = 0
        self.num_lives = 3
        self.__font = pygame.font.Font("freesansbold.ttf", consts.FONT_SIZE)
    ...
    def display(self, screen):
        ...
        screen.blit(score_value, consts.SCORE_TEXT_COORDINATES)
        screen.blit(num_lives_text, consts.NUM_LIVES_TEXT_COORDINATES)
        screen.blit(num_lives_value, consts.NUM_LIVES_TEXT_COORDINATES)
